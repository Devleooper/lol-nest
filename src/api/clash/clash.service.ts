...
import { PLAYERS_BY_SUMMONER_ID, TEAM_BY_ID, TOURNAMENTS, TOURNAMENT_BY_ID, TOURNAMENT_BY_TEAM_ID } from './routes';
...
export class ClashService {
     ...
     */
    public getClashPlayersBySummonerId(region: string, summonerId: string): Promise<Player[]> {
        return this.client.executeGet<Player[]>(region, PLAYERS_BY_SUMMONER_ID, [{ key: 'summonerId', value: summonerId }]);
    }
    ...
    public getTeamById(region: string, teamId: string): Promise<Team> {
        return this.client.executeGet<Team>(region, TEAM_BY_ID, [{ key: 'teamId', value: teamId }]);
    }
     ...
     */
    public getTournamentByTeamId(region: string, teamId: string): Promise<Tournament> {
        return this.client.executeGet<Tournament>(region, TOURNAMENT_BY_TEAM_ID, [{ key: 'teamId', value: teamId }]);
    }
     ...
     */
    public getTournamentById(region: string, tournamentId: string): Promise<Tournament> {
        return this.client.executeGet<Tournament>(region, TOURNAMENT_BY_ID, [{ key: 'tournamentId', value: tournamentId }]);
    }
}
