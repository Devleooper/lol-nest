...
import { SUMMONER_BY_ACCOUNT_ID, SUMMONER_BY_NAME, SUMMONER_BY_PUUID, SUMMONER_BY_ENCRYPTED_SUMMONER_ID } from './routes';
...
export class SummonerService {
     ...
     */
    public getSummonerByEncryptedAccountId(region: string, encryptedAccountId: string): Promise<Summoner> {
     ...
     * @returns a Summoner object
     */
    public getSummonerByName(region: string, summonerName: string): Promise<Summoner> {
     ...
     * @returns a Summoner object
     */
    public getSummonerByEncryptedSummonerId(region: string, encryptedSummonerId: string): Promise<Summoner> {
        return this.client.executeGet<Summoner>(region, SUMMONER_BY_ENCRYPTED_SUMMONER_ID,
